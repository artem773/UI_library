...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.dropdown = function () {
  for (let i = 0; i < this.length; i++) {
    ...
    (0,_core__WEBPACK_IMPORTED_MODULE_0__["default"])(this[i]).click(() => {
      (0,_core__WEBPACK_IMPORTED_MODULE_0__["default"])(`[data-toggle-id = "${id}"]`).fadeToggle(3000);
    });
  }
};
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.createModal = function () {
  ...
  for (let i = 0; i < this.length; i++) {
    ...
    /* btns = {count: num,
            settings:[[text, classNames = [], closeBtn, callback]]}; аргументи что ми передаем в btns*/
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.fadeToggle = function (duration, display, fin) {
  //метод для переключенія анімації 
  for (let i = 0; i < this.length; i++) {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.get = async function (url) {
  let dataTypeAnswear = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'json';
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.post = async function (url, data) {
  let dataTypeAnswear = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'text';
  let res = await fetch(url, {
    method: "POST",
    body: data
  });
...
(0,_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('[data-count="second"]').click(() => {
  (0,_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('.w-500').eq(1).fadeToggle(800);
});
